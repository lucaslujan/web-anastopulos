<?php
	...
	// Título del mensaje
	$titulo = "Nueva solicitud de reparación de $nombre para Administración Anastópulos";
	...
	if( ! isset($_POST['telefono']) )
		$errores[] = $mensajes_error['telefono'];


	// El mensaje HTML
	$data .= "<div class='mensaje'>
			<h1>Nuevo mensaje de $nombre</h1>
			<p><strong>Mail o teléfono</strong> $telefono</p>
	...
	if( count($errores) === 0 ) {
		...
		if(mail($receptor, $titulo, $data, $cabeceras, '-f reparaciones@admanasto.com.ar')) {
