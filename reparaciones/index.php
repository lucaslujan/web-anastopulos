<?php
	...
	$mensajes_error = array(
		'telefono' => 'Introduzca su mail o teléfono',
	...
	$mensaje_correcto = "Gracias, la información se envió correctamente";
			...
			<div class="col-md-6 mx-auto text-center">
			 ...
			 <div class="col-md-4 mx-auto">
				...
				<div class="form-group">
					<label for="nombre">Nombre y apellido</label><span class="requerido">*</span>
					<input class="form-control my-input" type="text" name="nombre" id="nombre" size="30" required placeholder="Nombre">
				</div>

				<div class="form-group">
					<label for="fecha">Mail o teléfono</label><span class="requerido">*</span>
					<input class="form-control my-input" type="text" name="telefono" id="telefono" placeholder="Introduce tu mail o teléfono" required>
				</div>
				...
				<div class="form-group">
					...
					<textarea class="form-control my-input" id="mensaje" name="mensaje" placeholder="Detalle las reparaciones" required></textarea>
				</div>
